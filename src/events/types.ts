...
export interface MessagePayloads {
  // chat messages
  "message:user": { userId: string, messageId: string, content: string, emailId?: string, threadId?: string };
  ...
  "email:composed": { userId: string, content: string, inReplyToId?: string, subject?: string, threadId?: string };
